...
\begin{itemize}
 ...
 \item konfiguracja węzłów (nodes) - zmienna ta zdefiniowana za pomocą listy komunikatów typu Nodes. Symulacja musi składać się przynajmniej z dwóch węzłów.
...
\begin{itemize}
 \item identyfikatora (id) zdefiniowanego jako 64 bahtowy ineteger.
\end{itemize}
