...
\paragraph{Podsumowanie wyników testu}
odyfikacja paramatru `p` umożliwiła wydłużenie czasu pracy sieci węzłów dla każdego z scenariuszy.
W komunikacji bezpośredniej (DIRECT) możliwym było uzyskanie 359 rund wymiany informacji. W przypadku, najgorszego scenariusza (PEGASIS, p=0.30), percentyl 0.5 wyniósł 360.7.
Najbardziej korzystne wyniki uzyskano dla scenariuszy (LEACH, p=0.10) oraz (LEACH, p=0.20), gdzie wartość percentyla 0.01 była większa niż 359.
